...
public class IntArrayCommunicationUtil extends CommunicationUtil<int []> {
    ...
    public void exchange(final int partner, 
            ...
            final int[] in, final int offIn, final int lenIn) throws IOException {
    ...
    @Override
    public void receive(int src, int[] data, int off, int len) throws IOException {
    ...
    @Override
    public void send(int dest, int[] data, int off, int len) throws IOException {
