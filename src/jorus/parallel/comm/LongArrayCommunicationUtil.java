...
public class LongArrayCommunicationUtil extends CommunicationUtil<long []> {
    ...
    public void exchange(final int partner, 
            ...
            final long[] in, final int offIn, final int lenIn) throws IOException {
    ...
    @Override
    public void receive(int src, long[] data, int off, int len) throws IOException {
    ...
    @Override
    public void send(int dest, long[] data, int off, int len) throws IOException {
