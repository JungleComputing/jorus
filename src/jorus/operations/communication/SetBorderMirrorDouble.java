...
public class SetBorderMirrorDouble extends SetBorder<double[]> {
	public void doIt(double[] destination, int numX, int numY) {
		if (doParallel) {
	...
	private void doItSequential(double[] destination, int numX, int numY) {
		if (numX > 0) {
	...
	private void doItParallel(double[] destination, int numX, int numY) {
