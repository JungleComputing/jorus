...
public class BpoMinValShort extends BpoVal<short[]> {
	protected short[] value;
	protected int extent;
	protected int pixelWidth;

	public BpoMinValShort(short[] p) {
		value = p;
	}

	@Override
	public void init(Array2d<short[]> s1, boolean parallel) {
	...
	public void doItSimple(short[] dst) {
		for (int j = 0; j < height; j++) {
	...
	private int normL1(final short[] data, final int index, final int length) {
		int result = 0;
