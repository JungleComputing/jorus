...
import jorus.operations.CxConvolution2dSep;
import jorus.operations.CxSetBorder;


public class CxGenConv2dSepGauss extends CxConvolution2dSep<double[]>
{
	...
	public CxGenConv2dSepGauss(CxArray2d<double[]> s1,
			CxArray2d<double[]> ker1, CxArray2d<double[]> ker2,
